...
import com.j2cengineering.motion.AxisTimeValueFormatter
import com.j2cengineering.motion.MyPlotListener
import com.j2cengineering.motion.R
import com.j2cengineering.motion.ThreadSafeLineChart
import com.j2cengineering.motion.ThreadSafeLineDataSet
 ...
 * Use the [TabbedDashboardFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class TabbedDashboardFragment : Fragment(), Cylinder.OnBasicDataListener, Cylinder.OnFullDataListener {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_tabbed_dashboard, container, false)
    }
...
//            })
            ...
            cylinder.addBasicDataListener(this)
            cylinder.addFullDataListener(this)
...
//                    }
    ...
    override fun onPause() {
        ...
        if(cylinder != null) {
            ...
            cylinder.removeBasicDataListener(this)
            cylinder.removeFullDataListener(this)
        }
...
//                        }
    ...
    companion object {
         ...
         * @return A new instance of fragment TabbedDashboardFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            TabbedDashboardFragment().apply {
            }
    }
}
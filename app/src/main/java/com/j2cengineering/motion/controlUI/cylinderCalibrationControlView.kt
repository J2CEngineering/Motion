...
class CylinderCalibrationControlView : View {
    ...
    private fun init(attrs: AttributeSet?, defStyle: Int) {
        ...
        val a = context.obtainStyledAttributes(
            attrs, R.styleable.cylinderCalibrationControlView, defStyle, 0
        )
    ...
    override fun onDraw(canvas: Canvas) {
        ...
        if(!_connected)
        {
            newCanvas.drawRect(0f, 0f,
                _finalImage.width.toFloat(), _pistonImage.height.toFloat(), _greyTransparentPaint)

            newCanvas.drawBitmap(_disconnectImage,(contentWidth.toFloat() / 2.0f - _disconnectImage.width / 2.0f),(_pistonImage.height.toFloat() / 2.0f - _disconnectImage.height / 2.0f), null )
